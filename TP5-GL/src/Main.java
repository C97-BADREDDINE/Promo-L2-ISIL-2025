...
public class Main {
   ...
   /*  Personne personne1 = new Personne("John", "Doe", "1234@ad.sda", "login", "1234");
    ...
    Personne personne3 = new Personne("Alice", "Johnson",  "adpi@d", "login", "1234");*/
        ...
        Vehicule v2 = new Vehicule(123154, "Renault");

        Technicien T1 = new Technicien("Yazid",222, v1, Specialite.MECANIQUE);
        T1.ajouetVehicule(v1);
        System.out.println(T1);

        Technicien T2 = new Technicien("Moha",444, v1, Specialite.ELECTRONIQUE);
        //T2.ajouetVehicule(v2);
        System.out.println(v2.getConducteur().getNom());

        
       

        /*System.out.println(T1.getChefEquipe());
        T1.designerChefEquipe(T2);
        System.out.println(T1.getChefEquipe());*/
